...
**Nota sobre certificados de Cisco:** Los cursos individuales de Google IT Support (Computer Hardware Basics, Operating Systems, System Administration, IT Security, Computer Networking) y los certificados de Cisco (Cybersecurity, Modern AI, IoT) están verificables en el perfil de Credly.

**Certificados sin link de verificación:**
- Digital Awareness
